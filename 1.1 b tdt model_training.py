# spec_augmentations-   "spec_augment": {
...
# ==========================================
# Save only specific epochs (epoch 3 only, final saved separately)
# ==========================================
class SaveSelectedEpochs(Callback):
    ...
    def __init__(self, directory: str, save_epochs: list):
        ...
        self.save_epochs = save_epochs  # e.g., [2, 3] for epochs 2 and 3 (0-indexed)
    ...
    def on_train_epoch_end(self, trainer, pl_module):
        ...
        # Only save if this epoch is in the save list
...
# Which epochs to save (0-indexed): epoch 3 means index 2, epoch 4 means index 3
# We save epoch 3 (index 2) here; final (epoch 4/index 3) is saved at the end
SAVE_EPOCHS = [2]  # Only save epoch 3 (0-indexed = 2)
...
# Add callback that only saves epoch 3 (index 2)
...
print(f"  Checkpoints: Epoch 3 + Final only (2 saves total)")
...
# Save Final (Epoch 4)
# ==========================================
print("Saving final model (epoch 4)...")
...
print(f"\nOutput files:")
print(f"  - model_epoch2.nemo + adapter_epoch2.pt (Epoch 3)")
print(f"  - model_final.nemo + adapter_final.pt (Epoch 4)")
